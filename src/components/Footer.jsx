...
function Footer() {
    return (
        <footer className="bg-footer-background py-16 text-center rounded-tr-[90px] md:text-start flex justify-center">
            <div className="mx-6 flex-1 flex flex-col gap-12 md:gap-20 md:flex-row max-w-7xl">
                ...
                <section className="flex flex-col gap-9 md:flex-1 md:flex-row md:justify-between">
                    {
                        menuItems.map((item, index) => (
                            <div key={index} className="md:flex-1">
                                <h4 className="text-text mb-6 font-medium text-xl">{item.page}</h4>
